<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EtheralforAspNet._Default" %>
...
<asp:Content ID="Content11" ContentPlaceHolderID="M3Extension" runat="server">				
<div class="inner">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent4" runat="server">
...
<asp:Content ID="Content10" ContentPlaceHolderID="M4Extension" runat="server">
								<div class="image filtered tinted" data-position="top right">
									<img src="images/pic03.jpg" alt="" />
								</div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent5" runat="server">
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent6" runat="server">
   
									<h2 class="major">Contact</h2>
									<p>Sed vel nibh libero. Mauris et lorem pharetra massa lorem turpis congue pulvinar. Vivamus sed feugiat finibus. Duis amet bibendum amet sed. Duis mauris ex, dapibus sed ligula tempus volutpat magna etiam.</p>
								</asp:Content>
<asp:Content ID="Content8" ContentPlaceHolderID="ContactContent" runat="server">
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent7" runat="server">
    
									<h2 class="major">Elements</h2>
									<p>Sed vel nibh libero. Mauris et lorem pharetra massa lorem turpis congue pulvinar. Vivamus sed feugiat finibus. Duis amet bibendum amet sed. Duis mauris ex, dapibus sed ligula tempus volutpat magna etiam. </p>
								</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="EndingContent" runat="server">
